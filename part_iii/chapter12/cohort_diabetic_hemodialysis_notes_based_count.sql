/******************************
** List of diabetic patients who underwent hemodialysis based on unstructured clinical notes
** Run time: 975 seconds
** Count in MIMIC-III = 1679
*******************************/

SELECT DISTINCT(NOTEEVENTS.SUBJECT_ID)
