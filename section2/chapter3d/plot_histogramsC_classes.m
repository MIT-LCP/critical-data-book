function plot_histogramsC_classes(IAC, NON_IAC, pathh, ftsize,unitsFig,nbins)
...
limites_yy=[30 30 70 25 35 45 40 40 35 60 90 30 50];
...
%     bhnongca=gca;
%     bhnonYLim = get(bhnongca,'YLim');

    
%     val=max(bhYLim(2),bhnonYLim(2));
%     ylim(bhgca,[0 val]);
%     ylim(bhnongca,[0 val]);
