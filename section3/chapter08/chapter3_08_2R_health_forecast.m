...
rand('seed', 1);
twea<-rbind(c(0.9,0.5),c(0.1,0.5))  % 2x2 transition matrix
rec <-matrix(0,5,100) =====zeros(5,100);  % array where the results are stored
...
p<-runif(1);  %random value between 0 and 1
